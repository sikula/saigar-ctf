...
const Categories = () => (
  <div style={{ padding: 25, width: '85%', margin: '0 auto' }}>
    ...
    <strong>HOME</strong>
    <p>
      Information that is relevant regarding the subject's home. This can include but not limited
      to:
    </p>
    <ul>
      <li>address</li>
    ...
    <ul>
      ...
      <li>Reddit accounts or sites of similar nature, online resume and physical description</li>
    </ul>

    <strong>ADVANCED SUBJECT INFO</strong>
    <p>Advanced relevant information regarding the subject. This can include but not limited to:</p>
    <ul>
    ...
    <p>
      Relevant information regarding the subject's last day seen. This can include but not limited
      to:
    </p>
    <ul>
    ...
    <p>
      Relevant information found on the dark web about the subject. This can include but not limited
      to:
    </p>
    <ul>
    ...
    <p>
      Relevant information pertaining to the current location of the subject. This can include but
      not limited to: new information on location (this does not include a Police update saying the
      person was found or an obituary - this will get you 150 points and can be under the category
